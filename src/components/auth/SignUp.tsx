        ...
        <div className="min-h-screen h-screen w-screen bg-gray-50 flex items-center justify-center">
            <div className="w-full h-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 bg-white shadow-2xl rounded-2xl overflow-hidden">
                ...
                <div className="flex flex-col justify-center items-center p-8 h-full w-full">
                    ...
                    <button
                        type="button"
                        className="w-full flex items-center justify-center gap-2 py-2 px-4 mb-4 border border-gray-300 rounded-2xl shadow-sm text-base font-medium cursor-pointer bg-white  text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 hover:text-blue-500 transition-colors duration-200"
                        style={{ height: '48px' }}
